...
[ICs]
  # 1. Setup the MOOSE monomial vectors.
...
[MultiApps]
  [sub_app]
    ...
    positions = '0 0 0'
    input_files = 'two_way_monomial_vector_multiapp_vector_copy_transfer_mfem.i'
    execute_on = timestep_begin
  []
[]

[Transfers]
  # Push the MOOSE monomial vector to MFEM subapp.
  [push]
    type = MultiAppVectorCopyTransfer
    to_multi_app = sub_app
    source_variable = moose_monomial_vector
    variable = mfem_monomial_vector
  []

  # Pull from MFEM subapp.
  [pull]
    type = MultiAppVectorCopyTransfer
