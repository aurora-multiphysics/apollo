...
[MultiApps]
  [sub_app]
    ...
    positions = '0 0 0'
    input_files = 'two_way_lagrange_vector_multiapp_vector_copy_transfer_mfem.i'
    execute_on = timestep_begin
  []
[]

[Transfers]
  # Push the MOOSE lagrange vector to MFEM subapp.
  [push]
    type = MultiAppVectorCopyTransfer
    to_multi_app = sub_app
    source_variable = moose_lagrange_vector
