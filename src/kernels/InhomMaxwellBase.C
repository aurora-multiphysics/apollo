...
// #include "InhomMaxwellBase.h"
// #include "Function.h"
// #include "Assembly.h"

// registerMooseObject("HammerheadApp", InhomMaxwellBase);

// InputParameters
// InhomMaxwellBase::validParams()
// {
//   InputParameters params = MaxwellBase::validParams();
//   return params;
// }

// InhomMaxwellBase::InhomMaxwellBase(const InputParameters & parameters)
...
// Real
// InhomMaxwellBase::curlCurlTerm()
// {
//   return _curl_u[_qp] * _curl_test[_i][_qp];
// }

// Real
// InhomMaxwellBase::dCurlCurlDU()
// {
//   return _curl_phi[_j][_qp] * _curl_test[_i][_qp];
// }

// Real
// InhomMaxwellBase::gaugePenaltyTerm()
// {
//   return _grad_u[_qp].tr() * _grad_test[_i][_qp].tr();
// }

// Real
// InhomMaxwellBase::dGaugePenaltyDU()
// {
//   return _grad_phi[_j][_qp].tr() * _grad_test[_i][_qp].tr();
// }

// Real
// InhomMaxwellBase::computeQpResidual()
// {
//   return (1.0/_mu[_qp]) *
//              (curlCurlTerm() + gaugePenaltyTerm()) +
//          (1.0/_rho[_qp]) * _test[_i][_qp] * _u_dot[_qp];
// }

// Real
// InhomMaxwellBase::computeQpJacobian()
// {
//   return (1.0/_mu[_qp]) * (dCurlCurlDU() + dGaugePenaltyDU()) +
