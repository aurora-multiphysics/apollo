...
registerMooseObject("ApolloApp", ComplexMaxwellImag);

InputParameters
ComplexMaxwellImag::validParams()
{
...
Real
ComplexMaxwellImag::computeQpResidual()
{
...
Real
ComplexMaxwellImag::computeQpJacobian()
{
  Real _epsilon_re_eff =  _epsilon_re[_qp] - _sigma_im[_qp]/_omega;
  Real _epsilon_im_eff =  _epsilon_im[_qp] + _sigma_re[_qp]/_omega;
...
Real
ComplexMaxwellImag::computeQpOffDiagJacobian(unsigned int jvar)
{
  Real _epsilon_re_eff =  _epsilon_re[_qp] - _sigma_im[_qp]/_omega;
  Real _epsilon_im_eff =  _epsilon_im[_qp] + _sigma_re[_qp]/_omega;
  if (jvar == _v_id)
